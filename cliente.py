  ...
  def widgets_framel(self):
    ...
    self.aba2 = Frame(self.abas)
        ...
        self.lb_nome.place(relx-0.008, rely-0.19)
            ...
            self.nome_entry Entry(self.abal)
            self.nome_entry.place(relx-0.008, rely 0.27, relwidth-0.46, relheight=0.08)

            # Criação da Label e Entrada do Telefone
            self.lb telefone Label(self.abal, text="Telefone", bg="#363636", fg="#808080", font ("Trebouchet", 10))
            self.lb_telefone.place(relx-0.008, rely-0.35)
            self.telefone_entry Entry(self.abal)
            self.telefone_entry.place(relx-0.008, rely-0.43, relwidth-0.20, relheight=0.08)

            # Criação da Label e Entrada do Cidade
            self.lb_cidade Label(self.abal, text="Cidade", bg="#363636", fg = "#808080", font = ("Trebouchet",self.lb_cidade.place(relx-0.25, rely-0.35)
            
            self.cidade_entry Entry(self.abal)
        ...
        def lista frame2(self):
            self.listaCli= ttk. Treeview(self.frame_2, height = 3, column ("coll", "col2", "col3", "col4"))
